...
\begin{document}
	...
	\caption{\centering Plataformas IoT para la industria Minera\\}
	\label{table:1}
\end{table}
	...
	\subsection{MARCO CONCEPTUAL}
		...
		%\item Machine Learning: Campo de la inte
	...
	%La metodología a seguir es TRIZ, acrónimo ruso que significa ``Teoría de Resolución de Problemas Inventivos'' y que podemos ver en la figura \ref{TRIZ}, es una metodología sistemática que plantea la idea de que los problemas, en su mayoría, comparten características similares, por lo que siguiendo esa idea presenta una serie de principios y soluciones estándares para abordar los problemas y sus contradicciones.
		\begin{figure}[H]
		\centering
		%\includegraphics[scale=0.55]{TRIZ.png}
		\includegraphics[scale=0.8]{metodologia.png}
		\captionsetup{justification=centering}
		%\caption{Metodología TRIZ}
...
\begin{table}[h]
	\centering
	\small % Reduce el tamaño de la fuente en la tabla
	\begin{tabularx}{\textwidth}{|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|c|c|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|}
		\hline
		\multirow{2}{*}{\makecell[l]{\textbf{Nombre}\\\textbf{del recurso}}} & 
		\multirow{2}{*}{\textbf{Formación}} & 
		\multirow{2}{*}{\textbf{Función}} & 
		\multicolumn{2}{c|}{\textbf{Dedicación}} & 
		\multirow{2}{*}{\makecell[l]{\textbf{Cantidad}\\ \textbf{del recurso}}} & 
		\multirow{2}{*}{\makecell[l]{\textbf{\$/Mes}\\ \textbf{(miles)}}} & 
		\multirow{2}{*}{\textbf{Total}} \\
		\cline{4-5}
		&  &  & \textbf{h/sem} & \textbf{Costo} &  &  & \\
		\hline
		\makecell[l]{Estudiante} & Pregrado & Realizar la totalidad del proyecto & 5 & 50.000 & 1 & 200 & 1'400.000 \\
		\hline
		\textbf{Total} & \multicolumn{6}{c|}{} & 1'400.000 \\
		\hline
	\end{tabularx}
	\caption{\centering Recurso humano\\}
	\label{tab:recurso_humano}
\end{table}
